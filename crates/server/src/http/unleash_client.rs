...
use unleash_edge_client_metrics::MetricsBatch;
use unleash_edge_metrics::EdgeInstanceData;
use unleash_edge_types::cli::ClientIdentity;
use unleash_edge_types::error::EdgeError::EdgeMetricsRequestError;
use unleash_edge_types::error::{CertificateError, EdgeError, FeatureError};
use unleash_edge_types::unleash_client::EdgeTokens;
use unleash_edge_types::{
    ClientFeaturesDeltaResponse, ClientFeaturesRequest, ClientFeaturesResponse, EdgeResult,
    EdgeToken, TokenValidationStatus, ValidateTokensRequest,
};
...
pub fn new_reqwest_client(
    ...
    build_identity(client_identity)
        ...
        .and_then(|client| {
            ...
            client
                .user_agent(format!("unleash-edge-{}", unleash_edge_types::EDGE_VERSION))
...
mod tests {
    ...
    use chrono::Duration;
    use ulid::Ulid;
    use unleash_edge_types::cli::{ClientIdentity, TlsOptions};
    use unleash_edge_types::{
    ...
    fn new_client_features_request(api_key: String, etag: Option<String>) -> ClientFeaturesRequest {
    ...
    async fn client_can_get_features() {
        ...
        let client_features_result = client
            .get_client_features(new_client_features_request("somekey".to_string(), None))
            .await;
    ...
    async fn client_handles_304() {
        ...
        let client = UnleashClient::new(srv.url("/").as_str(), None).unwrap();
        let client_features_result = client
            .get_client_features(new_client_features_request(
