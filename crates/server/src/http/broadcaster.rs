...
use crate::filters::{FeatureFilterSet, name_prefix_filter, project_filter_from_projects};
...
use unleash_edge_types::{EdgeJsonResult, EdgeResult, EdgeToken};
...
impl Broadcaster {
    ...
    pub async fn connect(
        ...
        token: EdgeToken,
        query: Query,
    ) -> EdgeResult<Sse<InfallibleStream<ReceiverStream<Event>>>> {
    ...
    async fn create_connection(
        ...
        token: &str,
    ) -> EdgeResult<mpsc::Receiver<Event>> {
