...
use unleash_edge_types::error::{EdgeError, FeatureError};
use unleash_edge_types::tokens::{cache_key, simplify};
use unleash_edge_types::{
    ClientFeaturesDeltaResponse, ClientFeaturesRequest, ClientFeaturesResponse, EdgeResult,
    EdgeToken, TokenRefresh, TokenType, TokenValidationStatus,
};
...
fn client_application_from_token_and_name(
    ...
    ClientApplication {
        ...
        metadata: MetricsMetadata {
            ...
            sdk_version: Some(format!("unleash-edge:{}", unleash_edge_types::EDGE_VERSION)),
...
mod tests {
    ...
    use unleash_edge_types::{EdgeToken, TokenRefresh, TokenType, TokenValidationStatus};
